 ...
 */
final class Version20240403155446 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE doctor DROP "user"');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE doctor ADD "user" VARCHAR(255) DEFAULT NULL');
