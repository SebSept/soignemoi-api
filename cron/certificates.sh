...
docker compose -f compose-prod.yaml run --rm --entrypoint "certbot certonly --webroot -w /var/www/certbot -d api.ecf.seb7.fr --email sebastienmonterisi@gmail.com --agree-tos --no-eff-email --force-renewal" certbot
# recharger nginx
